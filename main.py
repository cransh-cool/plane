...
from datasets.dataset_plane import Plane
...
def parse_args():
    ...
    parser.add_argument('--dataset', type=str, default='plane', help='Name of dataset')
    parser.add_argument('--data_dir', type=str, default='datasets/plane', help='Data directory')
...
if __name__ == '__main__':
    args = parse_args()
    dataset = {'plane': Plane}
    num_classes = {'dota': 15, 'hrsc': 1,'plane':11}
